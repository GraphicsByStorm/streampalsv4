...
export const animationTVShows = [
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.animation}&page=1`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.animation}&page=2`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.animation}&page=3`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.animation}&page=4`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.animation}&page=5`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.animation}&page=6`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.animation}&page=7`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.animation}&page=8`,
];
...
export const fantasyTVShows = [
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.fantasy}&page=1`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.fantasy}&page=2`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.fantasy}&page=3`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.fantasy}&page=4`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.fantasy}&page=5`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.fantasy}&page=6`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.fantasy}&page=7`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.fantasy}&page=8`,
];
...
export const horrorTVShows = [
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.horror}&page=1`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.horror}&page=2`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.horror}&page=3`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.horror}&page=4`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.horror}&page=5`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.horror}&page=6`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.horror}&page=7`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.horror}&page=8`,
];
...
export const comedyTVShows = [
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.comedy}&page=1`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.comedy}&page=2`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.comedy}&page=3`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.comedy}&page=4`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.comedy}&page=5`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.comedy}&page=6`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.comedy}&page=7`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.comedy}&page=8`,
];
...
export const crimeTVShows = [
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.crime}&page=1`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.crime}&page=2`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.crime}&page=3`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.crime}&page=4`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.crime}&page=5`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.crime}&page=6`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.crime}&page=7`,
    `https://api.themoviedb.org/3/discover/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.crime}&page=8`,
];
...
export const warTVShows = [
    `https://api.themoviedb.org/3/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.war}&page=1`,
    `https://api.themoviedb.org/3/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.war}&page=2`,
    `https://api.themoviedb.org/3/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.war}&page=3`,
    `https://api.themoviedb.org/3/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.war}&page=4`,
    `https://api.themoviedb.org/3/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.war}&page=5`,
    `https://api.themoviedb.org/3/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.war}&page=6`,
    `https://api.themoviedb.org/3/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.war}&page=7`,
    `https://api.themoviedb.org/3/tv?api_key=${key}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genreIDs.war}&page=8`,
];